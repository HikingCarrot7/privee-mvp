...
public class InvitationExpiredExceptionMapper implements ExceptionMapper<InvitationExpiredException> {
  @Context private UriInfo uriInfo;

  @Override
  public Response toResponse(InvitationExpiredException exception) {
